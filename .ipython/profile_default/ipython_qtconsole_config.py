...
c.IPythonWidget.font_family = u'Source Code Pro'

# The pygments lexer class to use.
# c.IPythonWidget.lexer_class = <IPython.utils.traitlets.Undefined object at 0x10843ac90>
