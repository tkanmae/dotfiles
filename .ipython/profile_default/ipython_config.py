...
# The name of a Pygments style to use for syntax highlighting:  algol_nu, algol,
# friendly, pastie, borland, vim, default, monokai, igor, tango, fruity, native,
# xcode, autumn, paraiso-dark, colorful, trac, lovelace, bw, paraiso-light,
# perldoc, vs, rrt, manni, emacs, murphy
